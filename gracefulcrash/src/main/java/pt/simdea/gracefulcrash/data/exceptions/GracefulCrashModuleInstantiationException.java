...
@NoArgsConstructor
public final class GracefulCrashModuleInstantiationException extends RuntimeException {
     ...
     */
    public GracefulCrashModuleInstantiationException(@NonNull final String detailMessage) {
        super(detailMessage);
    }
     ...
     */
    public GracefulCrashModuleInstantiationException(@NonNull final String detailMessage, @NonNull final Throwable throwable) {
     ...
     * @param throwable {@link Throwable} instance representing the cause of this exception.
     */
    public GracefulCrashModuleInstantiationException(@NonNull final Throwable throwable) {
        super(throwable);
    }
