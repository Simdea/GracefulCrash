...
@NoArgsConstructor
public final class UtilityInstantiationException extends RuntimeException {
     ...
     */
    public UtilityInstantiationException(@NonNull final String detailMessage) {
        super(detailMessage);
    }
     ...
     * @param throwable {@link Throwable} instance representing the cause of this exception.
     */
    public UtilityInstantiationException(@NonNull final Throwable throwable) {
        super(throwable);
    }
